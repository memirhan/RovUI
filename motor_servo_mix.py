...
try:
    ...
    while True:
        ...
        if sensor_degerleri is not None:
            ...
            if kol_value != last_kol_value:
                if kol_value == 0:
                    set_servo_angle(135)
                elif kol_value == 1:
                    set_servo_angle(90)
                print(f"Servo as? cellendi: {135 if kol_value == 0 else 90}")
                last_kol_value = kol_value
